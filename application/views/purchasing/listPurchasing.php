...
<head>
    ...
    $(document).ready(function() {
        ...
        $("#btnSaveDetail").click(function() {
            ...
            for (var lan = 1; lan <= 3; lan++) {
                var valIdDetail = $("input[name^='txtIdReqDetail" + lan + "']").map(function() {
                    return $(this).val();
                }).get();
                var valQty = $("input[name^='txtTtlApprove" + lan + "']").map(function() {
                    return $(this).val();
                }).get();
                var valCurr = $("select[name^='slcCurrency" + lan + "']").map(function() {
                    return $(this).val();
                }).get();
                var valPrice = $("input[name^='txtPrice" + lan + "']").map(function() {
                    return $(this).val();
                }).get();
                var valAmount = $("input[name^='txtAmount" + lan + "']").map(function() {
                    return $(this).val();
                }).get();
                for (var l = 0; l < valIdDetail.length; l++) {
                    if (lan == 1) {
                        if (idDetail1 == "") {
                            idDetail1 = valIdDetail[l];
                        } else {
                            idDetail1 += "*" + valIdDetail[l];
                        }
                        if (qty1 == "") {
            ...
            var reqDate = "";
            var valReqDate = $("input[id^='txtReqDate']").map(function() {
                return $(this).val();
            }).get();
            ...
            var poNo = "";
            var valPoNo = $("input[id^='txtPoNo']").map(function() {
                return $(this).val();
            }).get();
            ...
            var poNoOri = "";
            var valPoNoOri = $("input[id^='txtIntPoNoOri']").map(function() {
                return $(this).val();
            }).get();
            ...
            var datePo = "";
            var valDatePo = $("input[id^='txtDatePO']").map(function() {
                return $(this).val();
            }).get();
            ...
            var subject = "";
            var valSubject = $("input[id^='txtSubject']").map(function() {
                return $(this).val();
            }).get();
            ...
            var picVendor = "";
            var valPicVendor = $("input[id^='txtOrderName']").map(function() {
                return $(this).val();
            }).get();
            ...
            var vendorCom = "";
            var valVenCom = $("input[id^='txtOrderCompany']").map(function() {
                return $(this).val();
            }).get();
            ...
            var vendorCode = "";
            var valVenCode = $("input[id^='txtVendorCode']").map(function() {
                return $(this).val();
            }).get();
            ...
            var ship = "";
            var valShip = $("input[id^='txtShipName']").map(function() {
                return $(this).val();
            }).get();
            ...
            var shipCom = "";
            var valShipCom = $("select[id^='slcCompany']").map(function() {
                return $(this).val();
            }).get();
            ...
            var idPurch = "";
            var valPurch = $("input[id^='txtIdPurchase']").map(function() {
                return $(this).val();
            }).get();
    ...
    function editPoNo(po_no) {
        var poNo = po_no;
        $("#idTableModal").empty();
        $("#lblModal").text("Edit PO");
        var divNya = "";
        divNya += "<div class='row'>";
        divNya += "<div class='col-md-12'>";
        divNya += "<div class='col-md-2'>";
        divNya += "<label>Edit PO :</label>";
        divNya += "</div>";
        divNya += "<div class='col-md-10'>";
        divNya += "<textarea class='form-control input-sm' id='editPoNo'></textarea>";
        divNya += "</div>";
        divNya += "</div>";
    ...
    function sumAmount(id, noUrut = "") {
        ...
        var ttlAmount = $("input[id^='txtAmount" + noUrut + "']").map(function() {
            return $(this).val();
        }).get();
            ...
            <section class="wrapper site-min-height" style="min-height:400px;">
                ...
                <div class="form-panel" id="idDataTable">
                    <div class="row" id="btnNavAtas">
                        ...
                        <div class="col-md-2">
                            <button type="button" id="btnSearch" class="btn btn-warning btn-sm btn-block"
                                title="Search"><i class="fa fa-search"></i> Search</button>
                        </div>
                        <div class="col-md-2">
                            <button type="button" onclick="reloadPage();" id="btnSearch"
                                class="btn btn-success btn-sm btn-block" title="Refresh"><i class="fa fa-refresh"></i>
                                Refresh</button>
                        </div>
                    </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <input type="text" id="idLblReqDate1" class="form-control input-sm"
                                                disabled="disabled">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtPoNo1">PO No :</label>
                                            <input type="text" id="txtPoNo1" placeholder="No"
                                                class="form-control input-sm">
                                            <input type="hidden" id="txtIntPoNoOri1" value="">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtDatePO1">Date PO :</label>
                                            <input type="text" id="txtDatePO1" class="form-control input-sm" value=""
                                                placeholder="Date" onchange="createNoPO('1');" autocomplete="off">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtSubject1">Subject :</label>
                                            <input type="text" id="txtSubject1" class="form-control input-sm" value=""
                                                placeholder="Subject">
                                        </div>
                                    </div>
                                    <div class="row" style="padding: 10px 0px 10px 0px;">
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <input type="text" id="txtOrderName1" placeholder="Name"
                                                class="form-control input-sm">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtOrderCompany1">Vendor Company :</label>
                                            <input type="text" id="txtOrderCompany1" placeholder="Company"
                                                class="form-control input-sm">
                                            <input type="hidden" id="txtVendorCode1" value="">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtShipName1">Ship Name :</label>
                                            <input type="text" id="txtShipName1" placeholder="Name"
                                                    ...
                                                    <thead>
                                                        <tr style="background-color: #A70000;color: #FFF;height:40px;">
                                                            <th
                                                                ...
                                                                No</th>
                                                            <th
                                                                style="vertical-align: middle; width:29%;text-align:center;">
                                                                Name of Article</th>
                                                            <th
                                                            ...
                                                            <th
                                                                ...
                                                                Purchased Qty</th>
                                                            <th
                                                                style="vertical-align: middle; width:7%;text-align:center;">
                                                                Currency</th>
                                                            <th
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <input type="text" id="idLblReqDate2" class="form-control input-sm"
                                                disabled="disabled">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtPoNo2">PO No :</label>
                                            <input type="text" id="txtPoNo2" placeholder="No"
                                                class="form-control input-sm">
                                            <input type="hidden" id="txtIntPoNoOri2" value="">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtDatePO2">Date PO :</label>
                                            <input type="text" id="txtDatePO2" class="form-control input-sm" value=""
                                                placeholder="Date" onchange="createNoPO('2');">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtSubject2">Subject :</label>
                                            <input type="text" id="txtSubject2" class="form-control input-sm" value=""
                                                placeholder="Subject">
                                        </div>
                                    </div>
                                    <div class="row" style="padding: 10px 0px 10px 0px;">
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <input type="text" id="txtOrderName2" placeholder="Name"
                                                class="form-control input-sm">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtOrderCompany">Vendor Company :</label>
                                            <input type="text" id="txtOrderCompany2" placeholder="Company"
                                                class="form-control input-sm">
                                            <input type="hidden" id="txtVendorCode2" value="">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtShipName2">Ship Name :</label>
                                            <input type="text" id="txtShipName2" placeholder="Name"
                                                class="form-control input-sm" disabled="disabled">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtShipCompany">Ship Company :</label>
                                            <select name="slcCompany" id="slcCompany2" class="form-control input-sm"
                                                onchange="createNoPO('2');">
                                                <option value="">- Select -</option>
                                                <?php echo $optCompany; ?>
                                            </select>
                                        </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <input type="text" id="idLblReqDate3" class="form-control input-sm"
                                                disabled="disabled">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtPoNo3">PO No :</label>
                                            <input type="text" id="txtPoNo3" placeholder="No"
                                                class="form-control input-sm">
                                            <input type="hidden" id="txtIntPoNoOri3" value="">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtDatePO3">Date PO :</label>
                                            <input type="text" id="txtDatePO3" class="form-control input-sm" value=""
                                                placeholder="Date" onchange="createNoPO('3');">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtSubject3">Subject :</label>
                                            <input type="text" id="txtSubject3" class="form-control input-sm" value=""
                                                placeholder="Subject">
                                        </div>
                                    </div>
                                    <div class="row" style="padding: 10px 0px 10px 0px;">
                                        <div class="col-md-3 col-xs-12">
                                            ...
                                            <input type="text" id="txtOrderName3" placeholder="Name"
                                                class="form-control input-sm">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtOrderCompany3">Vendor Company :</label>
                                            <input type="text" id="txtOrderCompany3" placeholder="Company"
                                                class="form-control input-sm">
                                            <input type="hidden" id="txtVendorCode3" value="">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtShipName3">Ship Name :</label>
                                            <input type="text" id="txtShipName3" placeholder="Name"
                                                class="form-control input-sm" disabled="disabled">
                                        </div>
                                        <div class="col-md-3 col-xs-12">
                                            <label for="txtShipCompany3">Ship Company :</label>
                                            <select name="slcCompany" id="slcCompany3" class="form-control input-sm"
                                                onchange="createNoPO('3');">
                                                <option value="">- Select -</option>
                                                <?php echo $optCompany; ?>
                                            </select>
                                        </div>
