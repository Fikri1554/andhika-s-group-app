...
<body>
	...
	<div class="footer" style="position: fixed;bottom: 0px;">
		<table style="width:90%;margin-top:5px;" border="0" cellspacing="10">
			<tr>
				...
				<td style="width:20%;vertical-align:top;text-align:center;font-size:11px;">
					...
					<?php echo $masterQrCode; ?>
				</td>
				<td style="width:20%;vertical-align:top;text-align:center;font-size:11px;">
					<label>Superintendent</label><br>
					<?php echo $superIntendenQrCode; ?>
				</td>
				<td style="width:20%;vertical-align:top;text-align:center;font-size:11px;">
					<label>Management Approval</label><br>
					<?php echo $mngnAppvrQrCode; ?>
				</td>
				<td style="width:20%;font-size:9px;">
					NOTE : 	<br>
			...
			<tr>
				...
				<td style="vertical-align:top;text-align:center;border-bottom:2px solid black;font-size:11px;"><?php echo $masterName; ?></td>
				<td style="vertical-align:top;text-align:center;border-bottom:2px solid black;font-size:11px;"><?php echo $superIntenden; ?></td>
			...
			<tr>
				...
				<td style="vertical-align:top;text-align:center;font-size:10px;padding-top:-5px;"><?php echo $masterDate; ?></td>
				<td style="vertical-align:top;text-align:center;font-size:10px;padding-top:-5px;"><?php echo $superIntendenDate; ?></td>
