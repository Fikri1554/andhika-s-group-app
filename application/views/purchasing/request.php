...
<head>
    ...
    $(document).ready(function() {
        ...
        $("#btnSave").click(function() {
            ...
            $("#idLoading").show();
            $.post('<?php echo base_url("request/addRequest"); ?>', {
                    id: id,
                    vessel: vessel,
                    dateReq: dateReq,
                    appNo: appNo,
        ...
        $("#btnSaveDetail").click(function() {
            ...
            var codeNo = "";
            var valCodeNo = $("input[name^='txtCodePartNo']").map(function() {
                return $(this).val();
            }).get();
            ...
            var nameArtikel = "";
            var valArtikel = $("input[name^='txtNameArticle']").map(function() {
                return $(this).val();
            }).get();
            for (var l = 0; l < valArtikel.length; l++) {
                if (nameArtikel == "") {
                    nameArtikel = valArtikel[l];
                } else {
                    nameArtikel += "*" + valArtikel[l];
                }
            }
            var unit = "";
            var valUnit = $("input[name^='txtUnit']").map(function() {
                return $(this).val();
            }).get();
            ...
            var working = "";
            var valWork = $("input[name^='txtWorkOnBoard']").map(function() {
                return $(this).val();
            }).get();
            ...
            var stock = "";
            var valStock = $("input[name^='txtStockOnBoard']").map(function() {
                return $(this).val();
            }).get();
            ...
            var reqNya = "";
            var valReqNya = $("input[name^='txtTotalReq']").map(function() {
                return $(this).val();
            }).get();
            ...
            var mark = "";
            var valMark = $("select[name^='slcMarkDetail']").map(function() {
                return $(this).val();
            }).get();
            ...
            $("#idLoading").show();
            $.post('<?php echo base_url("request/addRequestDetail"); ?>', {
                    id: idEdit,
                    idReq: idReq,
                    codeNo: codeNo,
                    nameArtikel: nameArtikel,
                    unit: unit,
                    working: working,
                    stock: stock,
                    reqNya: reqNya,
        ...
        $("#btnApproval").click(function() {
            ...
            if (cfm) {
                $("#idLoadingModal").show();
                $.post('<?php echo base_url("request/approveModalReq"); ?>', {
                        id: idReq,
        ...
        $("#btnSearch").click(function() {
            ...
            $("#idLoading").show();
            $.post('<?php echo base_url("request/getRequest"); ?>/search/', {
                    startDate: startDate,
                    endDate: endDate
                },
                function(data) {
    ...
    function addRowDetail() {
        ...
        $.post('<?php echo base_url("request/addField"); ?>', {
                idField: id
            },
            function(data) {
    ...
    function showModal(id, typeView = "", typeApprove = "") {
        $("#idLoading").show();

        if (typeView != "") {
            $("#idBtnDetailRequest").css('display', 'none');
        } else {
            $("#idBtnDetailRequest").css('display', '');
        }
        ...
        $.post('<?php echo base_url("request/getModalDetailReq"); ?>', {
                idReq: id,
                typeApprove: typeApprove
            },
            function(data) {
    ...
    function delData(id) {
        ...
        if (cfm) {
            $.post('<?php echo base_url("request/delData"); ?>', {
                    id: id,
                    typeDel: "delReq"
                },
                function(data) {
    ...
    function saveFileModal() {
        ...
        $.ajax("<?php echo base_url('request/saveFile'); ?>", {
            method: "POST",
            data: formData,
            cache: false,
            contentType: false,
    ...
    function getDataFile(id) {
        $.post('<?php echo base_url("request/getDataFile"); ?>', {
                id: id
            },
            function(data) {
    ...
    function delFile(idReq = '', idDet = '', nmFile = '') {
        ...
        if (cfm) {
            ...
            $.post('<?php echo base_url("request/delFile"); ?>', {
                    idDet: idDet,
                    nmFile: nmFile
                },
                function(data) {
    ...
    function reloadPage() {
        window.location = "<?php echo base_url('request/');?>";
    }
    </script>
</head>
    ...
    <section id="container">
        <section id="main-content">
            <section class="wrapper site-min-height" style="min-height:400px;">
                <h3>
                    <i class="fa fa-angle-right"></i> Request Item<span style="display:none;padding-left:20px;"
                ...
                <div class="form-panel" id="idDataTable">
                    <div class="row">
                        <div class="col-md-2" id="btnNavAtas">
                            <button type="button" id="btnAddData" class="btn btn-primary btn-sm btn-block"
                                title="Add"><i class="fa fa-plus-square"></i> Add Data</button>
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="form-control input-sm" id="txtSearchStart" value=""
                                placeholder="Start Date" autocomplete="off">
                        </div>
                        <div class="col-md-2">
                            <input type="text" class="form-control input-sm" id="txtSearchEnd" value=""
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr style="background-color:#A70000;color:#FFF;height:40px;">
                                            <th style="vertical-align:middle;width:5%;text-align:center;" colspan="2">No
                                            </th>
                                            ...
                                            <th style="vertical-align:middle;width:10%;text-align:center;">Vessel</th>
                                            <th style="vertical-align:middle;width:10%;text-align:center;">Department
                                            </th>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" id="txtDateReq" value=""
                            ...
                            <div class="col-md-3 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" id="txtAppNo" value=""
                                        placeholder="Req. No">
                                </div>
                            </div>
                            <div class="col-md-3 col-xs-12">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="form-group" align="center">
                                    ...
                                    <button id="btnCancel" onclick="reloadPage();" class="btn btn-danger btn-sm"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-1 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtCodePartNo[]" class="form-control input-sm"
                                            id="txtCodePartNo" value="" placeholder="Code / Part No" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-12">
                                    <div class="form-group">
                                        <label for="txtNameArticle"><u>Name of Article:</u></label>
                                        <input type="text" name="txtNameArticle[]" class="form-control input-sm"
                                            id="txtNameArticle" value="" placeholder="Name of Article"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-1 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtUnit[]" class="form-control input-sm" id="txtUnit"
                                ...
                                <div class="col-md-1 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="txtWorkOnBoard[]"
                                            onkeypress="javascript:return isNumber(event)" class="form-control input-sm"
                                            id="txtWorkOnBoard" value="0" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-1 col-xs-12">
                                    <div class="form-group">
                                        <label for="txtStockOnBoard"><u>Stock:</u></label>
                                        <input type="text" name="txtStockOnBoard[]"
                                            onkeypress="javascript:return isNumber(event)" class="form-control input-sm"
                                            id="txtStockOnBoard" value="0" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-1 col-xs-12">
                                    <div class="form-group">
                                        <label for="txtTotalReq"><u>Request:</u></label>
                                        <input type="text" name="txtTotalReq[]"
                                            onkeypress="javascript:return isNumber(event)" class="form-control input-sm"
                                            id="txtTotalReq" value="0" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-md-2 col-xs-12">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="txtRemark[]" class="form-control input-sm"
                                ...
                                <div class="col-md-1 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-primary btn-block btn-xs" title="Add" id="btnAddField"
                                            onclick="addRowDetail();" type="button"><i
                ...
                <div class="modal-body" id="idModalDetail">
                    <div class="row">
                        ...
                        <div class="col-md-12" align="center" id="idBtnDetailRequest">
                            ...
                            <button id="btnApproval" class="btn btn-primary btn-sm" name="btnSave" title="Save">
                                <i class="fa fa-check-square-o"></i> Approve</button>
                            <button id="btnCancelModalDetail" onclick="reloadPage();" class="btn btn-danger btn-sm"
                                title="Cancel">
                                <i class="fa fa-ban"></i> Cancel</button>
                        </div>
                        <div class="col-md-12" style="font-size:11px;" align="right">Approve By : <label id="idUsrApp"
                                style="font-weight:bold;"></label></div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="idModalFile">
                    <legend style="text-align: right;">
                        <h4><img id="idLoadingModalFile" src="<?php echo base_url('assets/img/loading.gif'); ?>"
                                style="display:none;"> Upload File</h4>
                    </legend>
                    <div class="row">
                        <div class="col-md-4 col-xs-12">
                            <select name="slcFileUpload" id="slcFileUpload" class="form-control input-sm"
                                style="margin-top:5px;">
                            </select>
                        </div>
                        <div class="col-md-3 col-xs-12">
                            <input type="File" class="form-control input-sm" value="" id="uploadFile"
                                style="margin-top:5px;">
                        </div>
                        <div class="col-md-1 col-xs-12">
                            <button class="btn btn-warning btn-xs btn-block" onclick="$('#uploadFile').val('');"
                                style="margin-top:5px;">Clear</button>
                        </div>
                        <div class="col-md-2 col-xs-12">
                            <button class="btn btn-info btn-xs btn-block" onclick="saveFileModal();"
                    ...
                    <div class="row" style="margin-top:10px;">
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr style="background-color: #000;color: #FFF;height:40px;">
                                            ...
                                            <th style="vertical-align: middle; width:10%;text-align:center;">Code / Part
                                                No</th>
                                            <th style="vertical-align: middle; width:40%;text-align:center;">Name of
                                                Article</th>
                        ...
                        <div class="col-md-12" align="center">
                            ...
                            <button id="btnCancelModalFile" onclick="reloadPage();" class="btn btn-danger btn-sm"
                                title="Close">
