	...
	<section id="container">
		<section id="main-content">
			<section class="wrapper site-min-height" style="min-height:400px;">
				<h3>
					<i class="fa fa-angle-right"></i> Request Item<span style="display:none;padding-left:20px;" id="idLoading"><img src="<?php echo base_url('assets/img/loading.gif'); ?>" ></span>
				</h3>
				<div class="form-panel" id="idDataTable">
					<div class="row">
						...
						<div class="col-md-2">
							<input type="text" class="form-control input-sm" id="txtSearchStart" value="" placeholder="Start Date" autocomplete="off">
						</div>
						<div class="col-md-2">
							<input type="text" class="form-control input-sm" id="txtSearchEnd" value="" placeholder="End Date" autocomplete="off">
						</div>
						<div class="col-md-2">
							...
							<div class="col-md-12">
								...
								<div class="col-md-1 col-xs-12">
									<div class="form-group">
									    ...
									    <input type="text" name="txtCodePartNo[]" class="form-control input-sm" id="txtCodePartNo" value="" placeholder="Code / Part No" autocomplete="off">
									</div>
								</div>
								<div class="col-md-2 col-xs-12">
									<div class="form-group">
									    <label for="txtNameArticle"><u>Name of Article:</u></label>
									    <input type="text" name="txtNameArticle[]" class="form-control input-sm" id="txtNameArticle" value="" placeholder="Name of Article" autocomplete="off">
									</div>
								</div>
								<div class="col-md-1 col-xs-12">
									<div class="form-group">
									    <label for="txtUnit"><u>Unit:</u></label>
									    <input type="text" name="txtUnit[]" class="form-control input-sm" id="txtUnit" value="" autocomplete="off">
									</div>
								</div>
								<div class="col-md-1 col-xs-12">
									<div class="form-group">
									    <label for="txtWorkOnBoard"><u>Working:</u></label>
									    <input type="text" name="txtWorkOnBoard[]" onkeypress="javascript:return isNumber(event)" class="form-control input-sm" id="txtWorkOnBoard" value="0" autocomplete="off">
									</div>
								</div>
								<div class="col-md-1 col-xs-12">
									<div class="form-group">
									    <label for="txtStockOnBoard"><u>Stock:</u></label>
									    <input type="text" name="txtStockOnBoard[]" onkeypress="javascript:return isNumber(event)" class="form-control input-sm" id="txtStockOnBoard" value="0" autocomplete="off">
									</div>
								</div>
								<div class="col-md-1 col-xs-12">
									<div class="form-group">
									    <label for="txtTotalReq"><u>Request:</u></label>
									    <input type="text" name="txtTotalReq[]" onkeypress="javascript:return isNumber(event)" class="form-control input-sm" id="txtTotalReq" value="0" autocomplete="off">
									</div>
								</div>
								<div class="col-md-2 col-xs-12">
									<div class="form-group">
	        	...
	        	<div class="modal-body" id="idModalDetail">
	        		<div class="row">
						...
						<div class="col-md-12" align="center" id="idBtnDetailRequest">
							...
							<button id="btnCancelModalDetail" onclick="reloadPage();" class="btn btn-danger btn-sm" title="Cancel">
								<i class="fa fa-ban"></i> Cancel</button>
						</div>
						<div class="col-md-12" style="font-size:11px;" align="right">Approve By : <label id="idUsrApp" style="font-weight:bold;"></label></div>
