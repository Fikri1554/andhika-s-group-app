...
<head>
        ...
        $("#btnSaveView").click(function() {
            ...
            if (cfm) {
                ...
                $.post('<?php echo base_url("purchasing/savePO"); ?>/', {
                    ...
                    function(data) {
                        alert(data);
                        window.location = "<?php echo base_url('purchasing/exportPurchasing');?>/" +
                            idPurch;
                    },
                    "json"
                );
    ...
    function sendDataToERP() {
        ...
        var itemCode = "";
        var valItemCode = $("select[name^='slcErp_kodeBrg']").map(function() {
            return $(this).val();
        }).get();
        for (var l = 0; l < valItemCode.length; l++) {
            if (itemCode == "") {
                itemCode = valItemCode[l];
            } else {
                itemCode += "*" + valItemCode[l];
            }
        }
        ...
        var satuan = "";
        var valSatuan = $("select[name^='slcErp_satuan']").map(function() {
            return $(this).val();
        }).get();
        ...
        var stName = "";
        var valStName = $("select[name^='slcErp_satuan']").map(function() {
        ...
        $.post('<?php echo base_url("purchasing/sendToERP"); ?>/', {
                txtIdReqSendErp: txtIdReqSendErp,
                txtIdPurchSendErp: txtIdPurchListSendErp,
                ...
                satuan: satuan,
                stName: stName,
                txtVslCompanySendErp: txtVslCompanySendErp,
                txtVesselSendErp: txtVesselSendErp
            },
            function(data) {
                alert(data.stData);
                reloadPage();
    ...
    function createPO(idPurc = "") {
        ...
        $.post('<?php echo base_url("purchasing/viewPurchasing"); ?>/', {
            ...
            function(data) {
                $("#lblOrderTo").append(data.headNya[0].order_company + "<br><i style='font-size:10px;'>(" + data
                    .headNya[0].order_name + ")</i>");
                $("#lblPoDate").text(data.poDate);
                $("#lblSubject").text(data.headNya[0].subject);
                $("#lblShipTo").append(data.headNya[0].ship_company + "<br><i style='font-size:10px;'>(" + data
                    .headNya[0].ship_name + ")</i>");
    ...
    function getModalBargeCharge(id) {
        ...
        $.post('<?php echo base_url("purchasing/getOptionItemCode"); ?>/', {
            ...
            function(data) {
                ...
                $('#slcBCErpItemCodeBC').attr('onchange', "slcSatuanBargeCharge($('#slcBCErpItemCodeBC').val(),'" +
                    data.dbErpByCmp + "','');");
                ...
                $('#slcBCErpItemCodeBC2').attr('onchange',
                    "slcSatuanBargeCharge($('#slcBCErpItemCodeBC2').val(),'" + data.dbErpByCmp + "','2');");
    ...
    function hitungPPN() {
        ...
        if (optPpn == "tidak") {
            ...
            $("#idTtlAfterDisc").text(ttlAftr.toLocaleString(undefined, {
    ...
    function hitBargeCharge() {
        ...
        $("#txtAmountBC").val(amount.toLocaleString(undefined, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 2
        }));
        $("#txtAmountBC2").val(amount2.toLocaleString(undefined, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 2
        }));
        ...
        $("#txtSubTotalBC").val(subTotal.toLocaleString(undefined, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 2
        }));
        $("#txtAfterDiscBC").val(afterDisc.toLocaleString(undefined, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 2
        }));
        ...
        if (optPpn == "tidak") {
            ...
            $("#txtTotalPpnBC").val(amountWithPpn.toLocaleString(undefined, {
                minimumFractionDigits: 0,
                maximumFractionDigits: 2
            }));
            ...
            $("#txtTotalPpnBC").val(amountWithPpn2.toLocaleString(undefined, {
                minimumFractionDigits: 0,
                maximumFractionDigits: 2
            }));
        ...
        if (optPpn == "inklusif") {
            grandTotal = afterDisc.toLocaleString(undefined, {
                minimumFractionDigits: 0,
                maximumFractionDigits: 2
            });
        } else {
        ...
        $("#txtGrandTotalBC").val(grandTotal.toLocaleString(undefined, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 2
        }));
    }

    function showEditPoNoModal(id) {
        // Clear previous data
        $('#currentPoNo').text('');
        $('#currentDatePo').text('');
        $('#currentVendor').text('');
        ...
        $.ajax({
            url: '<?php echo base_url("purchasing/getPoDetailsAjax"); ?>',
            type: 'POST',
            data: {
                id: id
            },
            success: function(response) {
                ...
                if (response) {
                    if (!response.error) {
                        $('#currentPoNo').text(response.po_no);
                        $('#currentDatePo').text(response.po_date);
                        $('#currentVendor').text(response.order_company);
                        $('#currentShip').text(response.ship_name);
                    } else {
    ...
    function savePoNo() {
        var id = $('#editPoId').val();
        var newPoNo = $('#newPoNo').val();

        if (newPoNo != '') {
            // Make an AJAX request to update the PO number
            $.ajax({
                url: '<?php echo base_url("purchasing/editPoNo"); ?>',
                type: 'POST',
                data: {
                    id: id,
                    po_no: newPoNo
                ...
                success: function(response) {
                    if (response == 'success') {
                        ...
                        alert("Failed to update PO number. Response: " + response);
                    }
                },
            ...
            alert("Please enter a new PO number.");
        }
    }
    ...
    <section id="container">
        <section id="main-content">
            <section class="wrapper site-min-height" style="min-height:400px;">
                <h3>
                    <i class="fa fa-angle-right"></i> Purchasing<span style="display:none;padding-left:20px;"
                        id="idLoading"><img src="<?php echo base_url('assets/img/loading.gif'); ?>"></span>
                </h3>

                <div id="editPoNoModal" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="padding: 10px; background-color: #A70000;">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Edit PO Number</h4>
                            </div>
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="currentPoNo">PO Number:</label>
                                            <span id="currentPoNo"></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="currentDatePo">Date PO:</label>
                                            <span id="currentDatePo"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="currentVendor">Vendor:</label>
                                            <span id="currentVendor"></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="currentShip">Ship:</label>
                                            <span id="currentShip"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- New PO Number input -->
                                <div class="form-group">
                                    <label for="newPoNo">New PO Number:</label>
                                    <input type="text" class="form-control" id="newPoNo">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" onclick="savePoNo()">Save</button>
                ...
                <div class="form-panel" id="idDataTable">
                    <div class="row" id="btnNavAtas">
                        <div class="col-md-1">
                            <button id="btnBack" style="float:left;<?php echo $cssDisplay; ?>"
                                class="btn btn-success btn-xs btn-block" name="btnBack" title="Back"
                                onclick="reloadToMenu();">
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr style="background-color: #A70000;color: #FFF;height:40px;">
                                            ...
                                            <th style="vertical-align: middle; width:15%;text-align:center;">Date PO
                                            </th>
                ...
                <div class="form-panel" id="idViewDetail" style="display:none;">
                    <legend style="text-align: right;">
                        <label id="lblForm">
                            <span style="display:none;padding-right:10px;" id="idLoadingView"><img
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr style="background-color: #A70000;color: #FFF;height:40px;">
                                            ...
                                            <th style="vertical-align: middle; width:30%;text-align:center;">Description
                                            </th>
                                            ...
                                            <th style="vertical-align: middle; width:10%;text-align:center;">Unit Price
                                            </th>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12">
                            <div class="form-group" align="center">
                                ...
                                <button id="btnCancelView" onclick="reloadPage();" class="btn btn-danger btn-sm"
                ...
                <div class="form-panel" id="idFormSendERP" style="display:none;">
                    <legend style="text-align: right;">
                        <button id="btnBack" onclick="reloadPage();" style="float: left;" class="btn btn-success btn-xs"
                            name="btnBack" title="Back">
                            <i class="fa fa-reply-all"></i> Back
                        </button>
                        <label id="lblForm">
                            <i>:: Send To ERP ::</i>
                            ...
                            <div class="table-responsive">
                                <table
                                    ...
                                    <thead>
                                        <tr style="background-color: #A70000;color: #FFF;height:40px;">
                                            <th style="vertical-align: middle; width:5%;text-align:center;">No</th>
                                            <th style="vertical-align: middle; width:10%;text-align:center;">Kode Barang
                                            </th>
                                            <th style="vertical-align: middle; width:38%;text-align:center;">Description
                                            </th>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-12" align="center">
                            ...
                            <button id="btnSendErp" class="btn btn-primary btn-xs btn-block" title="Send To ERP"
                                onclick="sendDataToERP();">
                                <i class="glyphicon glyphicon-cloud-upload"></i> Send
                            </button>
                        </div>
                        <div class="col-md-6 col-xs-12" align="center">
                            <button id="btnCancelSendErp" class="btn btn-danger btn-xs btn-block" title="Cancel"
                                onclick="reloadPage();">
                                <i class="fa fa-ban"></i> Cancel
                            </button>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="idModalDetail">
                    <div class="row">
                        <div class="col-md-12">
                            <legend style="text-align: right;">
                                <img id="idLoadingModalBC" src="<?php echo base_url('assets/img/loading.gif'); ?>"
                                    style="display:none;">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-xs-12">
                            ...
                            <input type="text" class="form-control input-sm" id="txtPOBargeCharge" value=""
                                placeholder="Po No">
                        </div>
                        <div class="col-md-2 col-xs-12">
                            <label for="txtDate_poBargeCharge">Date :</label>
                            <input type="text" class="form-control input-sm" id="txtDate_poBargeCharge" value=""
                                placeholder="Date">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-1 col-xs-12">
                            ...
                            <input type="text" class="form-control input-sm" id="txtQtyBC" value="" placeholder="0"
                                oninput="hitBargeCharge();">
                        </div>
                        <div class="col-md-1 col-xs-12">
                        ...
                        <div class="col-md-2 col-xs-12">
                            ...
                            <input type="text" class="form-control input-sm" id="txtPriceBC" value="0"
                                oninput="hitBargeCharge();" style="text-align:right;">
                        </div>
                        <div class="col-md-2 col-xs-12">
                            <label for="txtAmountBC">Amount :</label>
                            <input type="text" class="form-control input-sm" id="txtAmountBC" value="0"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 col-xs-12">
                            ...
                            <input type="text" class="form-control input-sm" id="txtQtyBC2" value="" placeholder="0"
                                oninput="hitBargeCharge();">
                        </div>
                        <div class="col-md-1 col-xs-12">
                        ...
                        <div class="col-md-2 col-xs-12">
                            ...
                            <input type="text" class="form-control input-sm" id="txtPriceBC2" value="0"
                                oninput="hitBargeCharge();" style="text-align:right;">
                        </div>
                        <div class="col-md-2 col-xs-12">
                            <label for="txtAmountBC2">Amount :</label>
                            <input type="text" class="form-control input-sm" id="txtAmountBC2" value="0"
                                style="text-align:right;" disabled>
                        </div>
                    </div>
                    <div class="row" style="margin-top:10px;">
                        ...
                        <div class="col-md-3 col-xs-12" style="text-align:right;">
                            <input type="text" class="form-control input-sm" id="txtSubTotalBC" value=""
                                style="text-align:right;" disabled>
                        </div>
                    </div>
                    <div class="row" style="margin-top:10px;">
                        ...
                        <div class="col-md-3 col-xs-12" style="text-align:right;">
                            <input type="text" class="form-control input-sm" oninput="hitBargeCharge();" id="txtDiscBC"
                    ...
                    <div class="row" style="margin-top:10px;">
                        ...
                        <div class="col-md-3 col-xs-12" style="text-align:right;">
                            <input type="text" class="form-control input-sm" id="txtAfterDiscBC" value=""
                                style="text-align:right;" disabled>
                        </div>
                    </div>
                    <div class="row" style="margin-top:10px;">
                        <div class="col-md-9 col-xs-12" style="text-align:right;">
                            <label class="radio-inline">
                                <input type="radio" name="optPpnBC[]" onchange="hitBargeCharge();" value="tidak"
                                    checked>Tidak Ada PPN
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="optPpnBC[]" onchange="hitBargeCharge();"
                                    value="tidakdipungutpajak">PPN Tidak di pungut Pajak
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="optPpnBC[]" onchange="hitBargeCharge();" value="inklusif">PPN
                                Inklusif
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="optPpnBC[]" onchange="hitBargeCharge();" value="eksklusif">PPN
                                Eksklusif <i style="font-size:11px;color:red;">(+11%)</i>
                            </label>
                        </div>
                        <div class="col-md-3 col-xs-12">
                            <input type="text" class="form-control input-sm" id="txtTotalPpnBC" value="0"
                    ...
                    <div class="row" style="margin-top:10px;">
                        ...
                        <div class="col-md-3 col-xs-12" style="text-align:right;">
                            <input type="text" class="form-control input-sm" id="txtGrandTotalBC" value=""
                                style="text-align:right;" disabled>
                        </div>
                    </div>
                    <div class="row" style="margin-top:10px;">
                        <div class="col-md-6 col-xs-12">
                            ...
                            <button class="btn btn-primary btn-block btn-xs" title="Submit" id="btnAddField"
                                onclick="saveBargeCharge();" type="button"><i class="glyphicon glyphicon-check"></i>
                                Submit</button>
                        </div>
                        <div class="col-md-6 col-xs-12">
                            <button class="btn btn-danger btn-block btn-xs" title="Submit" id="btnAddField"
                                onclick="reloadPage();" type="button"><i class="fa fa-ban"></i> Cancel</button>
                        </div>
                    </div>
                </div>
            </div>
